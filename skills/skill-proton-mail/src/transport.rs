//! Thin wrapper over orion-skills ImapClient/SmtpClient for email operations.

use orion_skills::capability::email::{
    Email, EmailAddress, FetchOptions, OutgoingEmail, SendResult,
};
use orion_skills::transport::{ImapClient, SmtpClient};
use orion_skills::{SkillError, SkillResult};
