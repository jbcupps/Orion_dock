...
mod tests {
    ...
    fn test_path_traversal_blocked() {
        let tmp = std::env::temp_dir().join("orion_fs_test_traversal");
    ...
    fn test_path_outside_roots_blocked() {
        let tmp = std::env::temp_dir().join("orion_fs_test_outside");
        let _ = fs::remove_dir_all(&tmp);
        fs::create_dir_all(&tmp).unwrap();
    ...
    #[test]
    fn test_read_file() {
        let tmp = std::env::temp_dir().join("orion_fs_test_read");
        let _ = fs::remove_dir_all(&tmp);
        fs::create_dir_all(&tmp).unwrap();
    ...
    #[test]
    fn test_write_file() {
        let tmp = std::env::temp_dir().join("orion_fs_test_write");
        let _ = fs::remove_dir_all(&tmp);
        fs::create_dir_all(&tmp).unwrap();
    ...
    fn test_list_directory() {
        let tmp = std::env::temp_dir().join("orion_fs_test_list");
        let _ = fs::remove_dir_all(&tmp);
    ...
    fn test_search_files() {
        let tmp = std::env::temp_dir().join("orion_fs_test_search");
        let _ = fs::remove_dir_all(&tmp);
    ...
    fn test_read_nonexistent_file() {
        let tmp = std::env::temp_dir().join("orion_fs_test_nofile");
        let _ = fs::remove_dir_all(&tmp);
        fs::create_dir_all(&tmp).unwrap();
    ...
    fn test_health_check() {
        let tmp = std::env::temp_dir().join("orion_fs_test_health");
        let _ = fs::remove_dir_all(&tmp);
        fs::create_dir_all(&tmp).unwrap();
