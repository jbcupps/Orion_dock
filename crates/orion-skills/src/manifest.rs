...
pub struct RuntimeSection {
    ...
    pub runtime: String,
    #[serde(default, alias = "min_abigail_version")]
    pub min_orion_version: Option<String>,
    #[serde(default)]
    pub platforms: Vec<String>,
}
...
impl SkillManifest {
    ...
    pub fn parse(s: &str) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            min_orion_version: runtime
                .and_then(|r| r.min_orion_version.clone())
