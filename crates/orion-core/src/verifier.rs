...
mod tests {
    ...
    fn test_tamper_detection() {
        let temp = std::env::temp_dir().join("orion_core_tamper_test");
        ...
        let _ = fs::remove_dir_all(std::env::temp_dir().join("orion_core_tamper_test"));
    }
    ...
    fn test_repair_cycle() {
        ...
        let temp = std::env::temp_dir().join("orion_core_repair_test");
        let _ = fs::remove_dir_all(&temp);
        fs::create_dir_all(&temp).unwrap();
    ...
    fn test_full_identity_lifecycle() {
        ...
        let temp = std::env::temp_dir().join("orion_core_lifecycle_test");
        let _ = fs::remove_dir_all(&temp);
    ...
    fn test_partial_tampering_detected() {
        ...
        let temp = std::env::temp_dir().join("orion_core_partial_tamper");
        let _ = fs::remove_dir_all(&temp);
